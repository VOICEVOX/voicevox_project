...
* メンテナーチーム (maintainer)
  * VOICEVOX全体の判断を行うチーム
  * @Hiroshiba と @y-chan と @qryxip と @sevenc-nanashi の４名
* レビュワーチーム (reviewer)
  * コードレビューを行うチーム
  * 現在16名（Private設定の方もいるので紹介は割愛）
...
マージ権限はメンテナーチームと一部のレビュワーチームに付与されていて、メンテナー１人のApproveか、レビュワー２名以上のApproveが揃えばマージできるようになります。
